...
import com.app.lostandfound.view.PostEditDetailActivity;
 ...
 * Use the {@link MyFoundItemFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyFoundItemFragment extends BaseFragment {
    ...
    public static MyFoundItemFragment newInstance(String param1, String param2) {
        MyFoundItemFragment fragment = new MyFoundItemFragment();
    ...
    private void initView()
    {
        ...
        lostFoundPostAdapter=new LostFoundAdsFavoriteAdapter(context, false,lostAllPostArrayList, new ObjPostCallback() {
            @Override
            public void result(Object obj, int position,int type)
            {
                ...
                if(type==3)
                {
                    Intent intent=new Intent(context, PostEditDetailActivity.class);
    ...
    public void getAllLostPost(String page)
    {
        if (isInternetConnected()) {
            ...
            Call<LostAllPostResponse> call = apiInterface.GetFoundUserPost(userId,page);
