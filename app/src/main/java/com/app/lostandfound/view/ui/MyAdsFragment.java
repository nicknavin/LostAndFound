...
public class MyAdsFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AdsFavoriteFragment(), getContext().getResources().getString(R.string.ads));
        adapter.addFragment(new FavoriteLostFoundFragment(), getContext().getResources().getString(R.string.like));
