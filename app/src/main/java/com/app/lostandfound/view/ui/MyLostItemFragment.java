 ...
 * Use the {@link MyLostItemFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyLostItemFragment extends BaseFragment {
...
LinearLayoutManager linearLayoutManager;
    ...
    public static MyLostItemFragment newInstance(String param1, String param2) {
        MyLostItemFragment fragment = new MyLostItemFragment();
    ...
    public void getAllLostPost(String page)
    {
        if (isInternetConnected()) {
            ...
            Call<LostAllPostResponse> call = apiInterface.GetLostUserPost(userId,page);
