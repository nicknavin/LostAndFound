 ...
 * Use the {@link FavouriteLostFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FavouriteLostFragment extends BaseFragment {
    ...
    public static FavouriteLostFragment newInstance(String param1, String param2) {
        FavouriteLostFragment fragment = new FavouriteLostFragment();
    ...
    public void getAllLostPost(String page)
    {
        if (isInternetConnected()) {
            ...
            Call<LostAllPostResponse> call = apiInterface.GetLostLikedPost(userId,page);
